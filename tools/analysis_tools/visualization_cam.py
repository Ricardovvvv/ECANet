...
def main():
    ...
    parser.add_argument(
        '--target-layers',
        default='backbone.sffm_64.pc.conv_2.activate',
        help='Target layers to visualize CAM')
    parser.add_argument(
        '--category-index', default='13', help='Category to visualize CAM')
    parser.add_argument(
...
if __name__ == '__main__':
    ...
    #python tools/analysis_tools/visualization_cam.py /home/avl1/gfx/datasets/cityscapes/leftImg8bit/val/frankfurt/frankfurt_000001_068208_leftImg8bit.png  configs/ddrnet_external_class/ceshi_slim.py configs/ddrnet_external_class/sffm+attention+aux.pth  --out-file  tools/analysis_tools/1.jpg --cam-file tools/analysis_tools
